...
$(function () {
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > 0) {
      ...
      $('nav').css('paddingTop', '5px'), $('nav').css('paddingBottom', '15px');
    }
  ...
  owl.owlCarousel({
    items: 5,
    //5 items min-width 1000px and browser width
    itemsDesktop: [1000, 4],
    //4 items between  901px and 1000px
    itemsDesktopSmall: [900, 3],
    // betweem 601px and 900px  
    itemsTablet: [600, 2],
    //2 items between 0 and  600
    itemsMobile: false // itemsMobile disabled - inherit from itemsTablet option

  });
  owl.trigger('owl.play', 2000); // auto work
